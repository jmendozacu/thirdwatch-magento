...
class ChargebackApi
{
     ...
     *
     * @param \Swagger\Client\Model\Chargeback $json Pass chargeback to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain chargeback info. (required)
    ...
    /**
     * Operation chargebackWithHttpInfo
     *
     * Use chargeback to capture a chargeback reported on a transaction. This event can be called multiple times to record changes to the chargeback state.
     *
     * @param \Swagger\Client\Model\Chargeback $json Pass chargeback to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain chargeback info. (required)
