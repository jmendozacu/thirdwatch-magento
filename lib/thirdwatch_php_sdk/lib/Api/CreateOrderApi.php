...
class CreateOrderApi
{
     ...
     *
     * @param \Swagger\Client\Model\CreateOrder $body An order to submit for review. Only &#x60;_userID&#x60; is required field. But this should contain order info. (required)
