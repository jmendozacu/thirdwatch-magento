...
/**
 * LinkSessionToUserApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class LinkSessionToUserApi
{
    ...
    /**
     * Operation linkSessionToUser
     *
     * Use link_session_to_user to associate specific session to a user. Generally used only in anonymous checkout workflows.
     *
     * @param \Swagger\Client\Model\LinkSessionToUser $json Pass session and user to thirdwatch for link. Only &#x60;_userID&#x60; is required field. But this should contain session and user info. (required)
    ...
    /**
     * Operation linkSessionToUserWithHttpInfo
     *
     * Use link_session_to_user to associate specific session to a user. Generally used only in anonymous checkout workflows.
     *
     * @param \Swagger\Client\Model\LinkSessionToUser $json Pass session and user to thirdwatch for link. Only &#x60;_userID&#x60; is required field. But this should contain session and user info. (required)
