...
/**
 * ItemStatusApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ItemStatusApi
{
     ...
     *
     * @param \Swagger\Client\Model\ItemStatus $json Pass change item status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item status. (required)
    ...
    /**
     * Operation itemStatusWithHttpInfo
     *
     * Use item_status to update the status of item that you’ve already pass to Thirdwatch.
     *
     * @param \Swagger\Client\Model\ItemStatus $json Pass change item status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain item status. (required)
