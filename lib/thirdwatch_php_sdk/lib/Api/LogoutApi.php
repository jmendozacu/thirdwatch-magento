...
class LogoutApi
{
     ...
     *
     * @param \Swagger\Client\Model\Logout $json Pass logout status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain logout info. (required)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return \Swagger\Client\Model\EventResponse
     */
    public function logout($json)
    {
        list($response) = $this->logoutWithHttpInfo($json);
        return $response;
    }
     ...
     */
    public function logoutWithHttpInfo($json)
    {
        // verify the required parameter 'json' is set
        if ($json === null) {
            throw new \InvalidArgumentException('Missing the required parameter $json when calling logout');
        }
        // parse inputs
