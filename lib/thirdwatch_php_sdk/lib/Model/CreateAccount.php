 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateAccount implements ArrayAccess
{
     ...
     * @param \Swagger\Client\Model\PaymentMethod[] $_payment_methods The payment information associated with this account. Represented as an array of nested payment_method objects containing payment type, payment gateway, credit card bin, etc.
     * @return $this
     */
    ...
    /**
     * Sets _promotions
     * @param \Swagger\Client\Model\Promotion[] $_promotions The list of promotions that apply to this account. You can add one or more promotions when creating or updating an order. Represented as a JSON array of promotion objects. You can also separately add promotions to the account via the addPromotion event.
     * @return $this
     */
