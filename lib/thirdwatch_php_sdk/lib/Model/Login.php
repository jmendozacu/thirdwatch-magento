 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Login implements ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['_login_status'] = isset($data['_login_status']) ? $data['_login_status'] : null;
    ...
    {
        return $this->container['_login_status'];
    }

    /**
     * Sets _login_status
     * @param string $_login_status Use _loginStatus to represent the success or failure of the login attempt. e.g. _success, _failure
     * @return $this
     */
    public function setLoginStatus($_login_status)
    {
        $this->container['_login_status'] = $_login_status;
