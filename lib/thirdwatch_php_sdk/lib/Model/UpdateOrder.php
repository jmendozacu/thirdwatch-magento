 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateOrder implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateOrder';
    ...
    protected static $swaggerTypes = [
        ...
        '_billing_address' => '\Swagger\Client\Model\BillingAddress',
        '_shipping_address' => '\Swagger\Client\Model\ShippingAddress',
        '_payment_methods' => '\Swagger\Client\Model\PaymentMethod[]',
        '_promotions' => '\Swagger\Client\Model\Promotion[]',
        '_items' => '\Swagger\Client\Model\Item[]',
     ...
     * @param \Swagger\Client\Model\BillingAddress $_billing_address
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\ShippingAddress $_shipping_address
     * @return $this
     */
     ...
     * @param \Swagger\Client\Model\PaymentMethod[] $_payment_methods The payment information associated with this order. Represented as an array of nested payment_method objects containing payment type, payment gateway, credit card bin, etc.
     * @return $this
     */
    ...
    /**
     * Sets _promotions
     * @param \Swagger\Client\Model\Promotion[] $_promotions The list of promotions that apply to this order. You can add one or more promotions when creating or updating an order. Represented as a JSON array of promotion objects. You can also separately add promotions to the account via the addPromotion event.
     * @return $this
     */
    ...
    /**
     * Sets _items
     * @param \Swagger\Client\Model\Item[] $_items The list of items ordered. Represented as a JSON array of item
     * @return $this
     */
